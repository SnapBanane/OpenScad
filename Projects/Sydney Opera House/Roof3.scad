...
module roof() {
    ...
    translate([14,0,-6]) rotate([0,-5,180])
    ...
    scale([1,0.8,1]) translate([7.2,0,-2]) rotate([0,5,0])
            difference() { //first transition from biggest to middle shell / inside
                color("white") mirror([1,0,0]) shell1(radiuss2);
                translate([4,0,4])
    ...
    color("white") transition();              //transition bottom shell / sides
    mirror([0,1,0])  {                         
    ...
    translate([10,0,-1]) {
        rotate([-15,20,-20]) translate([1,-1,-0.5]) scale([0.7,0.7,1]) {
            color("white") transition();     //transition back shell left / sides
        }
    ...
    translate([10,0,-1]) mirror([0,1,0]) {
        rotate([-15,20,-20]) translate([1,-1,-0.5]) scale([0.7,0.7,1]) {
            color("white") transition();     //transition back shell right / sides
        }
    ...
    color([color])  {
            intersection() { //back shell inside
                binside(10);
                translate([14,0,-6]) scale([0.89,0.89,0.89])
                    balls(10);
            }
    }
